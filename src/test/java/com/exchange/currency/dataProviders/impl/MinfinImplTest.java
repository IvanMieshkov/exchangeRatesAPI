...
class MinfinImplTest {
    ...
    public void testLoadData() throws Exception {
        ...
        assertEquals(BigDecimal.valueOf(40.24), result.get(0).getBuyRate().setScale(2, RoundingMode.HALF_UP));
        assertEquals(BigDecimal.valueOf(40.62), result.get(0).getSellRate().setScale(2, RoundingMode.HALF_UP));
    }
}